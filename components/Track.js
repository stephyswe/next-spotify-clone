...
export default function Track({ chooseTrack, track }) {
  ...
  return (
    <div
      className="group flex cursor-default items-center justify-between space-x-20
     rounded-lg py-2 px-4 transition ease-out hover:bg-white/10"
    >
      <div className="flex items-center">
        ...
        <div>
          ...
          <p
            className="text-[13px] font-semibold text-[rgb(179,179,179)]
      ...
      <div className="flex items-center space-x-2.5 md:ml-auto">
        ...
        <div className="relative flex h-10 w-[85px] cursor-pointer items-center rounded-full border-2 border-[#262626] group-hover:border-white/40">
          ...
          {track.uri === playingTrack.uri && play ? (
            <div
              className="icon track-icon border-[#15883e] bg-[#15883e] hover:scale-110"
              onClick={handlePlay}
            >
            ...
            <div
              className="icon track-icon border-white/60 hover:scale-110 hover:border-[#15883e] hover:bg-[#15883e]"
              onClick={handlePlay}
            >
